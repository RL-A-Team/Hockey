...
parser.add_argument('--max_steps', type=int, default=1000, help='Number of maximal steps per episode')
...
parser.add_argument('--milestone', type=int, default=500, help='interval in which model is saved')
parser.add_argument('--eval_interval', type=int, default=100, help='interval to evaluate')
parser.add_argument('--update_target_every', type=int, default=1, help='update target every x episdoes')
...
parser.add_argument('--min_epsilon', type=float, default=0.01, help='min value for epsilon')
...
parser.add_argument('--hidden_size_actor', type=int, default=[256, 256], help='hidden size actor')
parser.add_argument('--hidden_size_critic', type=int, default=[256,256, 128], help='hidden size critic')
...
parser.add_argument('--job_id', default='test', help='slurm job idea')
parser.add_argument('--experiment', default='', help='type of experiment running')
parser.add_argument('--seed', default=1, help="set random seed")
...
parser.add_argument('--mode', type=int, default=2, help='Training mode: 2 - defense, 1 - shooting, 0 - normal')
parser.add_argument('--model', type=str, default=None, help='Path to pretrained model to load')
